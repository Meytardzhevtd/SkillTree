...
import { getCourseById, createModule, deleteModule, getModulesByCourseId } from '../services/courseApi';
...
const CoursePage: React.FC = () => {
    ...
    return (
        <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
            ...
            {modules.length === 0 ? (
                <p style={{ color: '#888' }}>В курсе пока нет модулей. Создайте первый модуль!</p>
            ) : (
                    ...
                    {modules.map((module) => (
                        ...
                        >
                            ...
                            >
                                ...
                                {!module.isOpen && <span style={{ marginLeft: '8px', color: '#888' }}>🔒</span>}
                            </div>
                            <button
                                onClick={(e) => {
                                    e.stopPropagation();
