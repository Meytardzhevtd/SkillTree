...
public class ModuleService {
    ...
    public Module create(CreateModuleDto createModuleDto) {
        ...
        if (oCourse.isPresent() == false) {
            throw new RuntimeException("Course with id = " + createModuleDto.getCourseId() + " not found");
        }
        Module saved = moduleRepository.save(new Module(null, oCourse.get(), createModuleDto.getName(), false));
        return saved;
    }
