...
// @Test
// void create_success_returnsCreatedAndLocation_and_passesDtoToService() throws
// Exception {
// String requestJson =
// "{\"taskTypeId\":1,\"moduleId\":2,\"content\":{\"q\":\"what\"}}";
...
// ArgumentCaptor<CreateTaskDto> captor =
// ArgumentCaptor.forClass(CreateTaskDto.class);
...
// ArgumentCaptor<UpdateTaskDto> captor =
// ArgumentCaptor.forClass(UpdateTaskDto.class);
...
// mvc.perform(get("/api/tasks").param("moduleId",
// "5")).andExpect(status().isOk())
// .andExpect(jsonPath("$",
// hasSize(2))).andExpect(jsonPath("$[0].id").value(1));
// }
